...
void runForceTest(double freq, int mag) {
    ...
    while (time < 3000 * 1000)
    {
        ...
        if (time % Ts <= Ts / 2)
        {
            // xd =   Mg * ((float)(time % Ts) / ((float)Ts / 2)) * (12.0 / 1.0);
            speed =   Mg / ((float)Ts / 2000.0);
        }

        if (time % Ts > Ts / 2 && time % Ts < Ts)
        {
            // xd =   Mg * (1.0 - ((float)(time % Ts) / ((float)Ts / 2) - 1.0)) * (12.0 / 1.0);
            speed = - Mg / ((float)Ts / 2000.0);
        }     
...
void runImpedanceTest(double k, double a, double kp, double kd) {
    ...
    while (time >= 30 * 1000 && time < 300 * 1000)
    {
        ...
        // spring deflection
        xs = ((float)deg5 * 25.4 / 8000.0) * (360.0 / (2. * 45.0 * pi)) * (13.0 / 1.0);
        ...
        {
            xd = - Mg * ((float)(time % (2 * Ts)) / ((float)T3)) * (12.0 / 1.0);
            vd = - (Mg / ((float)T3 / 1000.0)) * (12.0 / 1.0);
            // xd =   (Mg / 2.0) * (12.0 / 1.0) * cos(((float)(time % (2 * Ts) - 0 * T3) / (float)(2 * T3)) * 2.0 * pi) - (Mg / 2.0) * (12.0 / 1.0);
            // vd = - (Mg / 2.0) * (12.0 / 1.0) * sin(((float)(time % (2 * Ts) - 0 * T3) / (float)(2 * T3)) * 2.0 * pi) * (2.0 * pi / (2.0 * (float)T3 / 1000.0));
        }
        ...
        {
            xd = - Mg * (1.0 - ((float)(time % (2 * Ts)) / ((float)T3) - 2.0)) * (12.0 / 1.0);
            vd =   (Mg / ((float)T3 / 1000.0)) * (12.0 / 1.0);
            // xd = - (Mg / 2.0) * (12.0 / 1.0) * cos(((float)(time % (2 * Ts) - 2 * T3) / (float)(2 * T3)) * 2.0 * pi) - (Mg / 2.0) * (12.0 / 1.0);
            // vd =   (Mg / 2.0) * (12.0 / 1.0) * sin(((float)(time % (2 * Ts) - 2 * T3) / (float)(2 * T3)) * 2.0 * pi) * (2.0 * pi / (2.0 * (float)T3 / 1000.0));
        }
