...
#include "include/SEA0/SEAController0.h"
#include "_seacontroller0.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _seacontroller0reaction_function_0(void* instance_args) {
    _seacontroller0_self_t* self = (_seacontroller0_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _seacontroller0_sea_pos_t* sea_pos = self->_lf_sea_pos;
    int sea_pos_width = self->_lf_sea_pos_width; SUPPRESS_UNUSED_WARNING(sea_pos_width);
    _seacontroller0_target_pos_t* target_pos = self->_lf_target_pos;
    int target_pos_width = self->_lf_target_pos_width; SUPPRESS_UNUSED_WARNING(target_pos_width);
    #line 64 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Joint_Controllers/SEA0.lf"
...
#line 56 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_seacontroller0.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _seacontroller0reaction_function_1(void* instance_args) {
    _seacontroller0_self_t* self = (_seacontroller0_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    ...
    _seacontroller0_out_t* out = &self->_lf_out;
    #line 107 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Joint_Controllers/SEA0.lf"
...
#line 98 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_seacontroller0.c"
}
#include "include/api/reaction_macros_undef.h"
_seacontroller0_self_t* new__seacontroller0() {
    _seacontroller0_self_t* self = (_seacontroller0_self_t*)lf_new_reactor(sizeof(_seacontroller0_self_t));
    ...
    self->_lf__reaction_0.function = _seacontroller0reaction_function_0;
    ...
    self->_lf__reaction_1.function = _seacontroller0reaction_function_1;
