...
#include "include/SEA1/SEAController1.h"
#include "_seacontroller1.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _seacontroller1reaction_function_0(void* instance_args) {
    _seacontroller1_self_t* self = (_seacontroller1_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _seacontroller1_sea_pos_t* sea_pos = self->_lf_sea_pos;
    int sea_pos_width = self->_lf_sea_pos_width; SUPPRESS_UNUSED_WARNING(sea_pos_width);
    _seacontroller1_target_pos_t* target_pos = self->_lf_target_pos;
    int target_pos_width = self->_lf_target_pos_width; SUPPRESS_UNUSED_WARNING(target_pos_width);
    #line 64 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Joint_Controllers/SEA1.lf"
...
#line 56 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_seacontroller1.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _seacontroller1reaction_function_1(void* instance_args) {
    _seacontroller1_self_t* self = (_seacontroller1_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    ...
    _seacontroller1_out_t* out = &self->_lf_out;
    #line 107 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Joint_Controllers/SEA1.lf"
...
#line 98 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_seacontroller1.c"
}
#include "include/api/reaction_macros_undef.h"
_seacontroller1_self_t* new__seacontroller1() {
    _seacontroller1_self_t* self = (_seacontroller1_self_t*)lf_new_reactor(sizeof(_seacontroller1_self_t));
    ...
    self->_lf__reaction_0.function = _seacontroller1reaction_function_0;
    ...
    self->_lf__reaction_1.function = _seacontroller1reaction_function_1;
