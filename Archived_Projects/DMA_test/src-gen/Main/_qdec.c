...
#line 24 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Encoder.lf"
...
float cpr_qdec[7]=   {23040, 23040, 23040, 23040, 23040, 23040, 23040};
float cpr_sea[7]=     {400, 400, 400, 400, 400, 400, 400};
float SEA_offset[7]=     {0, -270, 0, -120, 200, 0, 0};
// float SEA_offset[7]=     {0, 0, 0, -120, 200, 0, 0};
float pi = 3.14159;
...
#line 83 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_qdec.c"
...
void _qdecreaction_function_0(void* instance_args) {
    ...
    #line 102 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Encoder.lf"
    MX_UART3_Init();
    MX_GPIO_Init();
    
    HAL_UART_Transmit(&huart3, qdec_reset, 1, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart3, qdec_enable, 1, HAL_MAX_DELAY);
#line 98 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_qdec.c"
}
...
void _qdecreaction_function_1(void* instance_args) {
    ...
    #line 110 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Encoder.lf"
    HAL_UART_Transmit(&huart3, qdec_reset, 1, HAL_MAX_DELAY);
#line 108 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_qdec.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _qdecreaction_function_2(void* instance_args) {
    ...
    #line 116 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Encoder.lf"
    long start = HAL_GetTick();
    
    // Get values for SEA encoders
    get_ticks(req_qdec[0]);
    for (int i=0; i<7; i++) {
      lf_set(sea_out[i],  (2*pi* ((float) (count[i]) / cpr_sea[i])) - (SEA_offset[i]/100));
...
#line 146 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_qdec.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _qdecreaction_function_3(void* instance_args) {
    ...
    #line 147 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/lib/Encoder.lf"
...
#line 165 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_qdec.c"
}
#include "include/api/reaction_macros_undef.h"
