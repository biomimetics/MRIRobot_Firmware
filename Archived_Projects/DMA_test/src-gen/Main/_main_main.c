...
#line 23 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
...
#line 85 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
...
void _main_mainreaction_function_0(void* instance_args) {
    ...
    #line 120 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    ...
    MX_UART5_Init();
    MX_UART6_Init();
#line 102 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
...
void _main_mainreaction_function_1(void* instance_args) {
    ...
    reactor_mode_t* RUN = &self->_lf__modes[2];
    lf_mode_change_type_t _lf_RUN_change_type = reset_transition;
    reactor_mode_t* HOME = &self->_lf__modes[1];
    lf_mode_change_type_t _lf_HOME_change_type = reset_transition;
    #line 134 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
...
#line 133 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_2(void* instance_args) {
    ...
    reactor_mode_t* RUN = &self->_lf__modes[2];
    lf_mode_change_type_t _lf_RUN_change_type = reset_transition;
    #line 162 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    if (at_home) {
      for(int i=0; i<7; i++) {
        target_pos[i] = 0;
      }
...
#line 155 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_3(void* instance_args) {
    ...
    #line 173 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    at_home = home.is_home->value;
#line 168 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_4(void* instance_args) {
    ...
    #line 177 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    for(int i=0; i<7; i++) {
      target_speed[i] = home.motor_speed[i]->value;
    }
#line 185 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_5(void* instance_args) {
    ...
    #line 183 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    for (int i=0; i<7; i++) {
      lf_set(motors.target_sel[i], 0);
      lf_set(motors.target_speed[i], target_speed[i]);
    }
#line 207 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_6(void* instance_args) {
    ...
    #line 202 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
...
#line 222 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_7(void* instance_args) {
    ...
    motors.target_speed = self->_lf_motors.target_speed;
    motors.target_speed_width = self->_lf_motors.target_speed_width;
    #line 212 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src/Main.lf"
    if (self->count == 0) {
      for (int i=0; i<7; i++) {
...
#line 261 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/DMA_test/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
_main_main_main_self_t* new__main_main() {
    ...
    self->_lf_home.is_home_reactions[0] = &self->_lf__reaction_3;
    ...
    #endif // FEDERATED_DECENTRALIZED
    self->_lf_home.motor_speed_reactions[0] = &self->_lf__reaction_4;
    ...
    self->_lf__sys_tick.last_tag = NEVER_TAG;
    #ifdef FEDERATED_DECENTRALIZED
    self->_lf__sys_tick.intended_tag = (tag_t) { .time = NEVER, .microstep = 0u};
    #endif // FEDERATED_DECENTRALIZED
    self->_lf__sys_tick_reactions[0] = &self->_lf__reaction_1;
    self->_lf__sys_tick_reactions[1] = &self->_lf__reaction_5;
    self->_lf__sys_tick_reactions[2] = &self->_lf__reaction_7;
    self->_lf__sys_tick.reactions = &self->_lf__sys_tick_reactions[0];
    self->_lf__sys_tick.number_of_reactions = 3;
    #ifdef FEDERATED
    self->_lf__sys_tick.physical_time_of_arrival = NEVER;
    #endif // FEDERATED
    self->_lf__sys_tick.is_timer = true;
    #ifdef FEDERATED_DECENTRALIZED
    self->_lf__sys_tick.intended_tag = (tag_t) { .time = NEVER, .microstep = 0u};
    #endif // FEDERATED_DECENTRALIZED
    ...
    #endif // FEDERATED_DECENTRALIZED
    self->_lf__switch_motor_reactions[0] = &self->_lf__reaction_6;
