...
#line 27 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/lib/ROS_Interface.lf"
...
#line 48 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_ros_interface.c"
...
void _ros_interfacereaction_function_0(void* instance_args) {
    ...
    #line 72 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/lib/ROS_Interface.lf"
    // Prep the send indicator
    tx_buffer[0] = 'e';
    
    // Prep UART interfaces
    MX_UART1_Init();
#line 63 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_ros_interface.c"
}
...
void _ros_interfacereaction_function_1(void* instance_args) {
    ...
    #line 80 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/lib/ROS_Interface.lf"
    if (!inFlight) {
...
#line 81 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_ros_interface.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _ros_interfacereaction_function_2(void* instance_args) {
    ...
    #line 92 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/lib/ROS_Interface.lf"
    if (!inFlight) {
...
#line 95 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_ros_interface.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _ros_interfacereaction_function_3(void* instance_args) {
    ...
    #line 101 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/lib/ROS_Interface.lf"
    if (HAL_UART_Receive(&huart1, rx_buffer, 1, 0) == HAL_OK && (rx_buffer[0] == 'p')) {
      if (HAL_UART_Receive(&huart1, rx_buffer, 12, 100) == HAL_OK) {
        for (int i=0; i<6; i++) {
    ...
    // }
#line 130 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_ros_interface.c"
}
#include "include/api/reaction_macros_undef.h"
