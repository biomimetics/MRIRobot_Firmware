...
#line 23 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
...
#line 89 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
...
void _main_mainreaction_function_0(void* instance_args) {
    ...
    #line 122 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
    ...
    MX_UART5_Init();
    MX_UART6_Init();
#line 106 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
...
void _main_mainreaction_function_1(void* instance_args) {
    ...
    #line 140 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
...
#line 134 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_2(void* instance_args) {
    ...
    #line 157 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
    for(int i=0; i<7; i++) {
      target_speed[i] = home.motor_speed[i]->value;
    }
#line 151 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_3(void* instance_args) {
    ...
    #line 163 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
    for (int i=0; i<7; i++) {
      lf_set(motors.target_sel[i], 0);
      lf_set(motors.target_speed[i], target_speed[i]);
    }
#line 173 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_4(void* instance_args) {
    ...
    motors.target_speed = self->_lf_motors.target_speed;
    motors.target_speed_width = self->_lf_motors.target_speed_width;
    #line 183 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
    printf("switch state: %d\r\n", self->count);
    HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_15);
    if (self->count == 0) {
      self->count = 1;
      lf_set(motors.target_speed[0], -50);
      lf_set(motors.target_speed[1], -50);
      lf_set(motors.target_speed[2], -50);
      lf_set(motors.target_speed[3], -50);
      lf_set(motors.target_speed[4], -50);
      lf_set(motors.target_speed[5], -50);
      lf_set(motors.target_speed[6], -50);
      target_pos[0] = 0;
      target_pos[1] = 0;
      target_pos[2] = 0;
      target_pos[3] = 0;
...
#line 230 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_5(void* instance_args) {
    ...
    #line 226 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src/Main.lf"
    for (int i=0; i<7; i++) {
      lf_set(motors.target_pos[i], target_pos[i]);
    }
#line 247 "/Users/naichenzhao/Desktop/MRIRobotProject/MRIRobot/Firmware/V2_bringup/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
_main_main_main_self_t* new__main_main() {
    ...
    self->_lf_home.motor_speed_reactions[0] = &self->_lf__reaction_2;
    ...
    #endif // FEDERATED_DECENTRALIZED
    self->_lf__motor_update_reactions[0] = &self->_lf__reaction_3;
    self->_lf__motor_update_reactions[1] = &self->_lf__reaction_5;
    ...
    #endif // FEDERATED_DECENTRALIZED
    self->_lf__switch_motor_reactions[0] = &self->_lf__reaction_4;
