...
#include "include/SEA4/SEAController4.h"
#include "_seacontroller4.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _seacontroller4reaction_function_0(void* instance_args) {
    _seacontroller4_self_t* self = (_seacontroller4_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _seacontroller4_sea_pos_t* sea_pos = self->_lf_sea_pos;
    int sea_pos_width = self->_lf_sea_pos_width; SUPPRESS_UNUSED_WARNING(sea_pos_width);
    _seacontroller4_target_pos_t* target_pos = self->_lf_target_pos;
    int target_pos_width = self->_lf_target_pos_width; SUPPRESS_UNUSED_WARNING(target_pos_width);
    #line 55 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/lib/Joint_Controllers/SEA4.lf"
...
#line 54 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_seacontroller4.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _seacontroller4reaction_function_1(void* instance_args) {
    _seacontroller4_self_t* self = (_seacontroller4_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    ...
    _seacontroller4_out_t* out = &self->_lf_out;
    #line 96 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/lib/Joint_Controllers/SEA4.lf"
    float RISE_CAP = 1;
    float FALL_CAP = 5;
    if (self->fsm_state) {
...
#line 92 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_seacontroller4.c"
}
#include "include/api/reaction_macros_undef.h"
_seacontroller4_self_t* new__seacontroller4() {
    _seacontroller4_self_t* self = (_seacontroller4_self_t*)lf_new_reactor(sizeof(_seacontroller4_self_t));
    ...
    self->_lf__reaction_0.function = _seacontroller4reaction_function_0;
    ...
    self->_lf__reaction_1.function = _seacontroller4reaction_function_1;
