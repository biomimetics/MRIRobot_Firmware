...
#line 23 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
...
#line 92 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
...
void _main_mainreaction_function_0(void* instance_args) {
    ...
    #line 125 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    ...
    MX_UART5_Init();
    MX_UART6_Init();
#line 109 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
...
void _main_mainreaction_function_1(void* instance_args) {
    ...
    #line 143 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    if (at_home) {
      for(int i=0; i<7; i++) {
        target_pos[i] = 0;
      }
...
#line 131 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_2(void* instance_args) {
    ...
    #line 154 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    at_home = home.is_home->value;
#line 144 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_3(void* instance_args) {
    ...
    #line 158 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    for(int i=0; i<7; i++) {
      target_speed[i] = home.motor_speed[i]->value;
    }
#line 161 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_4(void* instance_args) {
    ...
    #line 164 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    for (int i=0; i<7; i++) {
      lf_set(motors.target_sel[i], 0);
      lf_set(motors.target_speed[i], target_speed[i]);
    }
#line 183 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _main_mainreaction_function_5(void* instance_args) {
    ...
    motors.target_speed = self->_lf_motors.target_speed;
    motors.target_speed_width = self->_lf_motors.target_speed_width;
    #line 174 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/Main.lf"
    for (int i=0; i<7; i++) {
      lf_set(motors.target_speed[i], target_speed[i]);
    }
    for (int i=0; i<7; i++) {
...
#line 207 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_main_main.c"
}
#include "include/api/reaction_macros_undef.h"
