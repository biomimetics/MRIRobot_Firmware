...
#include "include/SEA6/SEAController6.h"
#include "_seacontroller6.h"
// ***** Start of method declarations.
// ***** End of method declarations.
#include "include/api/reaction_macros.h"
void _seacontroller6reaction_function_0(void* instance_args) {
    _seacontroller6_self_t* self = (_seacontroller6_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _seacontroller6_sea_pos_t* sea_pos = self->_lf_sea_pos;
    int sea_pos_width = self->_lf_sea_pos_width; SUPPRESS_UNUSED_WARNING(sea_pos_width);
    _seacontroller6_target_pos_t* target_pos = self->_lf_target_pos;
    int target_pos_width = self->_lf_target_pos_width; SUPPRESS_UNUSED_WARNING(target_pos_width);
    #line 55 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/lib/Joint_Controllers/SEA6.lf"
...
#line 54 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_seacontroller6.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _seacontroller6reaction_function_1(void* instance_args) {
    _seacontroller6_self_t* self = (_seacontroller6_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    ...
    _seacontroller6_out_t* out = &self->_lf_out;
    #line 96 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src/lib/Joint_Controllers/SEA6.lf"
    float RISE_CAP = 1;
    float FALL_CAP = 5;
    if (self->fsm_state) {
...
#line 92 "/Users/naichenzhao/Desktop/BML/MRIRobotProject/MRIRobot/Firmware/mini_arm/src-gen/Main/_seacontroller6.c"
}
#include "include/api/reaction_macros_undef.h"
_seacontroller6_self_t* new__seacontroller6() {
    _seacontroller6_self_t* self = (_seacontroller6_self_t*)lf_new_reactor(sizeof(_seacontroller6_self_t));
    ...
    self->_lf__reaction_0.function = _seacontroller6reaction_function_0;
    ...
    self->_lf__reaction_1.function = _seacontroller6reaction_function_1;
